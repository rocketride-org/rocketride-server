...
[MCP — Cloud & External Agents](/connect/mcp/http/cloud) for the alternative:
...
[MCP — Cloud & External Agents](/connect/mcp/http/cloud#no-api-key-use-rocketride-from-claude-code)
