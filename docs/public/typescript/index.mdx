...
<a className="rr-side-card" href="/clients/typescript/database-drizzle">
  <span className="rr-side-card__head"><LuDatabase className="rr-card-icon" /><span className="rr-side-card__title">Drizzle over Pipelines</span></span>
  <span className="rr-side-card__body">A Drizzle ORM driver whose SQL rides a pipeline instead of a TCP socket.</span>
</a>
