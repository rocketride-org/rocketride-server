...
> For how nodes wire together and how to add one, see
> [Pipeline Nodes](index.md). For testing, see [Node Testing](testing.md).
...
| `test`          |          | Automated test cases (see [Node Testing](testing.md)).                     |
...
[Pipeline Nodes → How nodes connect](index.md#how-nodes-connect).
