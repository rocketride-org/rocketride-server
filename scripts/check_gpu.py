...
COMPAT_NOTE = (
    f"This project pins torch {PROJECT_TORCH} (CUDA {PROJECT_CUDA}). "
    "That build supports sm_61, sm_70, sm_75, sm_80, sm_86, sm_90, and sm_120 (Blackwell). "
    "Driver must support CUDA 12.8+. See https://pytorch.org/get-started/locally/ for other builds."
)
