...
class OutputCapture:
    ...
    def __init__(self):
        """Initialise empty output and call buffers."""
...
class NodeTestHarness:
    ...
    def __init__(self, service: ServiceConfig):
        """Set up harness for the given service configuration."""
...
class MockEntry:
    ...
    def __init__(self, **kwargs):
        """Initialise mock entry with optional overrides."""
...
class MockQuestion:
    ...
    def __init__(self):
        """Initialise empty questions and context lists."""
        self.questions = []
        self.context = []
...
class MockDoc:
    ...
    def __init__(self, page_content='', metadata=None, embedding=None, score=0.0):
        """Initialise mock document with optional content and metadata."""
...
class MockAnswer:
    ...
    def __init__(self, text='', score=0.0):
        """Initialise mock answer with text and score."""
        self.text = text
        self.score = score
...
class TestNodeLanes:
    ...
    def test_lane_has_valid_name(self, service: ServiceConfig, lane: LaneDefinition):
        ...
        valid_lanes = {
            ...
            'reference',  # Reference image lane for similarity/matching nodes
        }
