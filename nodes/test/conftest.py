...
def pytest_generate_tests(metafunc):
    ...
    if 'node_test_config' in metafunc.fixturenames:
        ...
        # Groups: ML/heavy (anonymize, ocr, ner, embedding_image); image/video (image_cleanup, frame_grabber);
        # LLM/local (llm_anthropic, llm_ollama); audio/TTS (audio_tts — pulls torch, kokoro, piper-tts).
        skip_nodes = {
            'anonymize',
            'llm_anthropic',
            'llm_ollama',
