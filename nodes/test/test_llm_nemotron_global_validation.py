"""Unit tests for llm_nemotron's IGlobal save-time validation.

Loads nodes/src/nodes/llm_nemotron/IGlobal.py with stubbed heavy imports
...
def test_validate_config_skips_probe_for_self_hosted_serverbase(monkeypatch):
    """A non-cloud (NIM/vLLM) serverbase returns early without probing."""
