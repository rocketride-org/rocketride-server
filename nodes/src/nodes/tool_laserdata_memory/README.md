...
| `laserdata.namespace` | `string` | **Namespace**<br/>The memory scope every call reads and writes, e.g. <code>customer:42</code>. The agent can pass a namespace per call; a namespace is required on the call or here. | `""` |
