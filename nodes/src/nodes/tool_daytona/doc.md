...
| Section | Fields |
| --- | --- |
| Daytona | `type`, `tool_daytona.apikey`, `tool_daytona.api_url`, `tool_daytona.target`, `tool_daytona.snapshot`, `tool_daytona.language`, `tool_daytona.auto_stop_minutes`, `tool_daytona.exec_timeout_secs`, `tool_daytona.max_output_chars` |
