...
| Section | Fields |
| --- | --- |
| FalkorDB | `type`, `tool_falkordb.host`, `tool_falkordb.port`, `tool_falkordb.username`, `tool_falkordb.password`, `tool_falkordb.tls`, `tool_falkordb.graph`, `tool_falkordb.allow_writes`, `tool_falkordb.max_rows`, `tool_falkordb.query_timeout_ms` |
