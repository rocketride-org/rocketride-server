...
| Client (SDK) docs | `docs/development/client-readme-schema.md`; sources in `docs/public/<name>/` |
| MCP surface | `docs/public/mcp/` |
| Engine internals | `docs/development/engine.md` |
| WebSocket (5565) protocol | `docs/development/websocket/` |
...
- WebSocket (5565) / engine protocol surface → `docs/development/websocket/`.
