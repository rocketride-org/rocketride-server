...
| WebSocket (5565) protocol | `docs/public/product/protocols/websocket/` |
| Crash reporting / minidumps | `docs/development/engine/crash-reporting.md` |
| Shell apps | `docs/public/product/develop/apps.md` (app API), `docs/development/apps/index.md` (monorepo setup) |
