...
| Build or edit a node | `docs/internal/node-readme-schema.md` (README contract), `docs/internal/node-schema.md` (services.json contract), `docs/internal/nodes.md` (catalog) |
| Test a node | `docs/internal/node-testing.md` |
| Client (SDK) docs | `docs/internal/client-readme-schema.md`; sources in `docs/clients/<name>/` |
| MCP surface | `docs/mcp/` |
| Engine / WebSocket protocol | `docs/internal/engine.md`, `docs/internal/engine-protocol/` |
| Apps / builder / hooks | `docs/internal/apps.md`, `docs/internal/builder.md`, `docs/internal/pre-commit-hooks.md` |
...
- MCP protocol surface → `docs/mcp/`.
- WebSocket (5565) / engine protocol surface → `docs/internal/engine-protocol/`.
...
- Contributor/internal docs → `docs/internal/`.
...
`docs/internal/node-readme-schema.md`. The
...
`docs/clients/<name>/readme.md` or `docs/mcp/readme.md`, then run
