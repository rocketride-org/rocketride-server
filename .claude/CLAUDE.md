...
- The `.pipe` schema (`packages/client-typescript/src/client/types/pipeline.ts`) ->
  its reference regenerates to `/pipeline-reference` (mounted from
  `packages/client-typescript/docs/reference/pipeline`, generated — do not edit).
