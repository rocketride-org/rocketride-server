 ...
 *
 * RocketRide brand mark + header for the embedded widgets. The icon is the
 * official mark from github.com/rocketride-org/branding with the swoosh
 * recolored to currentColor (adapts to the host's light/dark theme); the
 * flame keeps the brand #F93822.
 */

const ICON_SVG =
	'<svg viewBox="0 0 191 192" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
...
/** Prepend the branded header (mark + title) to the document body. */
