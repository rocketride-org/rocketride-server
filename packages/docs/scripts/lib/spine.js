...
const SPINE = [
	...
	},
	{
		...
		items: [
			...
			{ id: 'clients/typescript', label: 'TypeScript SDK', mount: true },
			{ id: 'clients/python', label: 'Python SDK', mount: true },
			{ id: 'clients/vscode', label: 'VS Code Extension', mount: true },
		],
	},
	{
		label: 'Guides',
