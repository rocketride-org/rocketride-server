 ...
 */
export const StatusHeader: React.FC<StatusHeaderProps> = ({ name, taskStatus, currentElapsed, onPipelineAction, extraActions, disableRun, isSubscribed }) => {
	...
	return (
		<div style={commonStyles.cardHeader}>
			...
			<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
				<div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
					{extraActions}
					{onPipelineAction && <StatusActions taskStatus={taskStatus} onPipelineAction={onPipelineAction} disableRun={disableRun} isSubscribed={isSubscribed} />}
				</div>
 ...
 */
export const StatusActions: React.FC<StatusActionsProps> = ({ taskStatus, onPipelineAction, disableRun, isSubscribed }) => {
	const state = taskStatus?.state ?? ITaskState.NONE;
