...
/**
 * Renders a single compact metric tile.
 *
 * @param props - {@link IMiniCardProps}.
 * @returns The tile element.
 */
export function MiniCard({ value, label }: IMiniCardProps): React.ReactElement {
	...
	return (
		<div style={styles.card}>
			<div style={compact ? { ...styles.value, ...styles.valueCompact } : styles.value}>{value}</div>
