                        ...
                        components={{
                                ...
                                code: ({ inline, className, children, ...rest }: any) => {
                                        ...
                                        if (!inline && lang === 'html') {
                                                ...
                                                // Fix F-06: removed `allow-scripts` from the sandbox attribute.
                                                // JavaScript execution in LLM-supplied HTML blocks is disabled to
                                                // prevent phishing UI, resource exhaustion, and postMessage abuse.
                                                // The iframe can still render static HTML/CSS content safely.
                                                // If scripted HTML is required in future, add a strict CSP via the
                                                // `csp` attribute rather than re-enabling allow-scripts globally.
                                                return (
                                                        <iframe
                                                                srcDoc={isDoc ? code : HTML_WRAPPER(code)}
                                                                sandbox=""
                                                                title="Rendered HTML"
                                                                style={S.iframe}
                                                        />
