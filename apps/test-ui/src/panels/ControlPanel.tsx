			...
			<div style={styles.controlGroup}>
				...
				<div style={styles.controlRow}>
					...
					<input
						...
						max={256}
						disabled={isActive}
						onChange={(e) => set('pipelines', Number(e.target.value))}
					/>
				</div>
				<div style={styles.controlRow}>
					...
					<input
						type="number"
						style={styles.controlInput}
						value={config.sendsPerPipeline}
						min={0}
						max={10000}
						disabled={isActive}
						onChange={(e) => set('sendsPerPipeline', Number(e.target.value))}
					/>
				</div>
				<div style={styles.controlRow}>
					...
					<select
						...
						value={config.rampUp}
						disabled={isActive}
						onChange={(e) => set('rampUp', e.target.value as TestConfig['rampUp'])}
					>
			...
			<div style={styles.controlGroup}>
				...
				<div style={styles.controlRow}>
					...
					<input
						...
						max={5000}
						disabled={isActive}
						onChange={(e) => set('randomDelay', Number(e.target.value))}
					/>
				...
				<div style={styles.controlRow}>
					...
					<input
						type="number"
						style={styles.controlInput}
						value={config.killProbability}
						min={0}
						max={100}
						disabled={isActive}
						onChange={(e) => set('killProbability', Number(e.target.value))}
					/>
				...
				<div style={styles.controlRow}>
					...
					<select
						style={styles.controlSelect}
						value={config.corruptionLevel}
						disabled={isActive}
						onChange={(e) => set('corruptionLevel', e.target.value as TestConfig['corruptionLevel'])}
					>
			...
			<div style={styles.controlGroup}>
				...
				<div style={styles.controlRow}>
					...
					<select
						...
						disabled={isActive}
						onChange={(e) => set('payloadSize', e.target.value as TestConfig['payloadSize'])}
					>
				...
				<div style={styles.controlRow}>
					...
					<select
						...
						disabled={isActive}
						onChange={(e) => set('payloadType', e.target.value as TestConfig['payloadType'])}
					>
