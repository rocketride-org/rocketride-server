...
export const SCENARIOS: ChaosScenario[] = [
	{
		...
		tags: [{ label: 'stress', color: 'stress' }, { label: 'connection', color: 'conn' }],
	...
	},
	{
		...
		tags: [{ label: 'stress', color: 'stress' }, { label: 'data', color: 'data' }],
	...
	},
	{
		...
		tags: [{ label: 'chaos', color: 'chaos' }, { label: 'data', color: 'data' }],
	...
	},
	{
		...
		tags: [{ label: 'chaos', color: 'chaos' }, { label: 'connection', color: 'conn' }],
