// =============================================================================
// TEST-UI — Module Federation Remote (Stress & Chaos Testing app)
// =============================================================================
...
export default defineConfig(() => {
	return {
		...
		output: {
			distPath: {
				root: path.join(process.env.ROCKETRIDE_BUILD_ROOT ?? '../../build', 'apps', 'test-ui'),
			},
			assetPrefix: 'auto',
			cleanDistPath: true,
			sourceMap: {
