...
// NOTE: shell:connectionChange is NOT declared here — the per-view unions in
// types.ts compose ShellHostToWebview (the single source for shell pushes)
// beside this union; a duplicate member here would narrow its payload.
