...
export const DropZone: React.FC<DropZoneProps> = ({ onFilesSelected, isProcessing, isDragOver, onDragOver, onDragLeave, onDrop, disabled = false, onBrowse }) => {
	...
	return (
		<div className={dropZoneClasses} onDragOver={onDragOver} onDragLeave={onDragLeave} onDrop={onDrop} onClick={openFilePicker} role="button" tabIndex={disabled ? -1 : 0} aria-label="Drop files or click to upload">
